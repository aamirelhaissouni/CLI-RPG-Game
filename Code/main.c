...
int main(void) {
  ...
  // MAP INITIALIZATION USING MALLOC REMEMBER TO FREE MALLOC SPACE AT END OF
  // CODE
  ...
  location_init(
      castleE, "Goblin Castle Enterance\n",
  ...
  location_init(
      secondFloor, "Castle Second Floor.\n",
  ...
  location_init(
      castleT, "The Goblin's tresure room.\n",
  ...
  // gotta wait until player defeats the boss here to link this: link_loc(caveT,
  // lodge, 'e');
